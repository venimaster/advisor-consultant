...
--
-- Хост: localhost
-- Время создания: Дек 13 2011 г., 12:50
...
(2, 'Да', 'Скорее да, чем нет', 'Не знаю', 'Скорее нет, чем да', 'Нет', NULL, NULL, NULL, NULL, NULL, NULL),
...
(5, 'Всегда', 'Часто', 'Иногда', 'Редко', 'Никогда', NULL, NULL, NULL, NULL, NULL, NULL),
...
(14, 'Отталкиваюсь от них в ходе рассуждения', 'Учитываю в ходе рассуждения', 'Пренебрегаю ими', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
...
(12, 'Прикладные интеллектуальные системы', NULL, NULL),
...
(17, 'Конечный пользователь', NULL, NULL),
...
(19, 'Когнитолог', NULL, NULL),
(20, 'Инженер-интерпретатор', NULL, NULL),
...
(23, 'Среда общения пользователя', NULL, NULL),
...
(26, 'Средство вывода', NULL, NULL),
(27, 'Машина логического вывода', NULL, NULL),
(28, 'Дедуктивная машина', NULL, NULL),
(29, 'Интерпретатор', NULL, NULL),
...
(43, 'Продукционная модель представления знаний', NULL, 'модель, основанная на правилах, позволяющих представить знания в виде предложений типа: ЕСЛИ {<условие>} ТО {<действие>} [ИНАЧЕ {<действие>}], где условие – это образец для поискав БЗ; действие – действия или операторы, выполняемые при успешном исходе поиска.'),
(44, 'Семантическая сеть', NULL, 'ориентированный граф с помеченными дугами и состояниями (т.е. вершины сети могут иметь различную интерпретацию, а дуги-отношения принадлежат к различным типам: логическим, лингвистическим, теоретико-множественным, квантифицированным).'),
(45, 'Фрейм', NULL, 'формализованная модель для отображения абстрактного образа или ситуации:\r\nF=<I,v1 g1 [p1],...,vk gk [pk]>\r\nгде:\r\nI - имя фрейма;\r\nvj - имя j-го слота;\r\ngj - значение j-го слота;\r\npj - процедуры, присоединенные к j-му слоту.'),
...
(57, 'Формирование знаний', NULL, 'если процесс получения знаний осуществляется путем анализа данных и выявления скрытых закономерностей в них с использованием специального математического аппарата и инструментальных средств, то уместно говорить о формировании знаний.'),
...
--
-- Дамп данных таблицы `ideal_pair`
--

INSERT INTO `ideal_pair` (`u_id`, `pair_id`) VALUES
(2, 3);
...
--
-- Дамп данных таблицы `project_group`
--

INSERT INTO `project_group` (`u_id`, `pr_id`) VALUES
(1, 1),
(2, 1),
(3, 1);
...
(43, 'Рассел С., Норвинг П. Искусственный интеллект: современный  подход, 2-е изд..: Пер. с англ. – М.: Издательский дом «Вильямс», 2006.'),
(44, 'Рыбина Г.В. Основы построения интеллектуальных систем: учеб. пособ./ Г.В.Рыбина. – М.: Финансы и статистика; ИНФРА-М, 2010.');
...
(1, 'Часто ли Вы испытываете тягу к новым впечатлениям, к тому, чтобы встряхнуться, испытать возбуждение?', NULL, NULL, 'Да', 1),
(2, 'Часто ли Вы чувствуете, что нуждаетесь в друзьях, которые вас понимают, могут одобрить или утешить?', NULL, 'Да', NULL, 1),
(3, 'Считаете ли Вы себя безобидным человеком?', NULL, NULL, 'Да', 1),
(4, 'Очень ли трудно Вам отказаться от своих намерений?', NULL, 'Да', NULL, 1),
(5, 'Вы обдумываете свои дела не спеша, предпочитаете подождать, прежде чем действовать?', NULL, NULL, 'Нет', 1),
(6, 'Всегда ли Вы сдерживаете свои обещания, не считаясь с тем, что Вам это невыгодно?', 'Да', NULL, NULL, 1),
(7, 'Часто ли у Вас бывают спады и подъёмы настроения?', NULL, 'Да', NULL, 1),
(8, 'Вообще, Вы действуете и говорите быстро, не задерживаясь для обдумывания?', NULL, NULL, 'Да', 1),
(9, 'Возникало ли у Вас чувство, что Вы несчастный человек, хотя серьёзной причины для этого не было?', NULL, 'Да', NULL, 1),
(10, 'Верно ли, что Вы почти на всё могли бы решиться, если дело пошло на спор?', NULL, NULL, 'Да', 1),
(11, 'Вы смущаетесь, когда хотите завязать разговор с незнакомым человеком?', NULL, 'Да', NULL, 1),
(12, 'Бывает ли, что разозлившись, Вы выходите из себя?', 'Нет', NULL, NULL, 1),
(13, 'Часто ли бывает, что Вы действуете под влиянием минуты?', NULL, NULL, 'Да', 1),
(14, 'Часто ли Вас терзают мысли о том, что чего-либо не следовало делать или говорить?', NULL, 'Да', NULL, 1),
(15, 'Предпочитаете ли Вы книги встречам с другими людьми?', NULL, NULL, 'Нет', 1),
(16, 'Верно ли, что Вас довольно легко задеть?', NULL, 'Да', NULL, 1),
(17, 'Вы любите часто бывать в компании?', NULL, NULL, 'Да', 1),
(18, 'Бывают ли у Вас мысли, о которых неудобно рассказывать другим?', 'Нет', NULL, NULL, 1),
(19, 'Верно ли, что Вы иногда полны энергии так, что всё горит в руках, а иногда вялые?', NULL, 'Да', NULL, 1),
(20, 'Предпочитаете ли иметь поменьше приятелей, но зато особенно близких?', NULL, NULL, 'Нет', 1),
(21, 'Вы много мечтаете?', NULL, 'Да', NULL, 1),
(22, 'Когда на Вас кричат, отвечаете тем же?', NULL, NULL, 'Да', 1),
(23, 'Часто ли Вас терзает чувство вины?', NULL, 'Да', NULL, 1),
(24, 'Все ли ваши привычки хороши и желательны?', 'Да', NULL, NULL, 1),
(25, 'Способны ли Вы дать волю чувствам и вовсю повеселиться в шумной компании?', NULL, NULL, 'Да', 1),
(26, 'Можно ли сказать, что нервы бывают у Вас часто натянуты до предела?', NULL, 'Да', NULL, 1),
(27, 'Вы слывёте за человека весёлого и живого?', NULL, NULL, 'Да', 1),
(28, 'После того как дело сделано, часто ли Вы мысленно возвращаетесь к нему, думая, что могли бы сделать лучше?', NULL, 'Да', NULL, 1),
(29, 'Вы обычно чувствуете себя спокойным, когда находитесь в компании?', NULL, NULL, 'Нет', 1),
(30, 'Бывает ли, что Вы передаёте слухи?', 'Нет', NULL, NULL, 1),
(31, 'Бывает ли, что Вам не спится из-за того, что разные мысли лезут Вам в голову?', NULL, 'Да', NULL, 1),
(32, 'Если хотите узнать о чём-нибудь, то предпочитаете прочитать в книге, чем спросить у друзей?', NULL, NULL, 'Нет', 1),
(33, 'Бывает ли у Вас сильное сердцебиение?', NULL, 'Да', NULL, 1),
(34, 'Нравится ли Вам работа, требующая пристального внимания?', NULL, NULL, 'Нет', 1),
(35, 'Бывают ли у Вас приступы дрожи?', NULL, 'Да', NULL, 1),
(36, 'Если бы Вы знали, что никогда сказанное Вами не будет раскрыто, всегда бы высказывались в духе общепринятого?', 'Да', NULL, NULL, 1),
(37, 'Вам неприятно бывать в компании, где подшучивают друг над другом?', NULL, NULL, 'Нет', 1),
(38, 'Вы раздражительны?', NULL, 'Да', NULL, 1),
(39, 'Вам нравится работа, которая требует быстроты действия?', NULL, NULL, 'Да', 1),
(40, 'Верно ли, что Вам нередко не дают покоя мысли о разных неприятностях и ужасах, которые могли бы произойти, хотя всё закончилось благополучно?', NULL, 'Да', NULL, 1),
(41, 'Вы медлительны и неторопливы в движениях?', NULL, NULL, 'Нет', 1),
(42, 'Вы когда-нибудь опаздывали на свидания или на работу?', 'Нет', NULL, NULL, 1),
(43, 'Часто ли вам снятся кошмары?', NULL, 'Да', NULL, 1),
(44, 'Вы любите поговорить настолько, что никогда не упустите удобный случай с незнакомым человеком?', NULL, NULL, 'Да', 1),
(45, 'Беспокоят ли вас какие-либо боли?', NULL, 'Да', NULL, 1),
(46, 'Вы чувствовали бы себя несчастным, если долго не смогли бы видеться со своими знакомыми, друзьями?', NULL, NULL, 'Да', 1),
(47, 'Можете ли Вы назвать себя нервным человеком?', NULL, 'Да', NULL, 1),
(48, 'Среди людей, которых Вы знаете, есть ли такие, которые Вам явно не нравятся?', 'Нет', NULL, NULL, 1),
(49, 'Можете ли Вы сказать, что Вы уверенный в себе человек?', NULL, NULL, 'Да', 1),
(50, 'Обидитесь ли Вы, если покритиковать недостатки Ваши и Вашей работы?', NULL, 'Да', NULL, 1),
(51, 'Вы считаете, что трудно получить настоящее удовольствие от вечеринки?', NULL, NULL, 'Нет', 1),
(52, 'Беспокоит ли Вас чувство, что Вы чем-то хуже других?', NULL, 'Да', NULL, 1),
(53, 'Вам трудно внести оживление в скучную компанию?', NULL, NULL, 'Да', 1),
(54, 'Бывает ли, что Вы говорите о вещах, в которых совсем не разбираетесь?', 'Нет', NULL, NULL, 1),
(55, 'Вы беспокоитесь о своём здоровье?', NULL, 'Да', NULL, 1),
(56, 'Вы любите подшучивать над другими?', NULL, NULL, 'Да', 1),
(57, 'Страдаете ли Вы от бессонницы?', NULL, 'Да', NULL, 1);
...
(1, '9208084', 'Аминев Булат Даянович', 'муж', 21, 2, 'venima', 1, 1, 2, 1, NULL, 'полезависимость', NULL, NULL, NULL, NULL),
(2, '123', 'Кусков Иван Михайлович', 'муж', 21, 3, 'stud', 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, NULL),
(3, '123', 'Рыбина Галина Валентиновна', NULL, 35, 1, 'prep', 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, NULL);
